...
class CommentModel(Model):
    ...
    created_at = db.Column(db.Integer, nullable=False) # дата создания комментария
    updated_at = db.Column(db.Integer, nullable=False) # дата редактирования комментария