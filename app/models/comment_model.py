...
class CommentModel(Model):
    ...
    created_up = db.Column(db.DateTime, nullable=False) # дата создания комментария
    updated_ap = db.Column(db.DateTime, nullable=False) # дата редактирования комментария